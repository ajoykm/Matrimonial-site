<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Main.aspx.cs" Inherits="Main" Title="Matrimonial Site" MasterPageFile ="~/HomeIn.master"%>
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" ID="m"  runat="server">
    <table style="width: 336px; height: 272px">
        <tr>
            <td background="img/bk3.jpg" style="width: 131px; height: 465px" valign="top">
                <table style="width: 336px">
                    <tr>
                        <td class="input" colspan="3">
                            <strong><span style="font-size: 11pt; color: #9b0033">Free Matromonial
                                Site</span></strong></td>
                    </tr>
                    <tr>
            ...
            <td style="width: 114px; height: 465px" valign="top">
                <table style="width: 344px">
                    <tr>
                        <td class="inputt" style="color: darkgreen">
